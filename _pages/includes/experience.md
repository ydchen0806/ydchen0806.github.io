...
#work-section > ul > li > ul {
  margin-top: 1em;
  padding-left: 0;
  list-style-type: none;
}

#work-section > ul > li > ul > li {
  margin-bottom: 0.6em;
  line-height: 1.7;
  color: #444;
  padding-left: 1.2em;
...
#work-section > ul > li > ul > li::before {
  content: "•";
  color: #FF9800;
  font-weight: bold;
  position: absolute;
...
- <div class="company-header">
    <img src="/images/ubtech.png" alt="UBTECH Robotics Logo" width="144"/>
    <div>
      <p class="company-name"><a href="https://www.ubtrobot.com/">UBTECH Robotics (优必选)</a></p>
